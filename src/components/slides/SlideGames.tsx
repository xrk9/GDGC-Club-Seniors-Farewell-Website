  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-full w-full items-center px-12 md:px-48">
      ...
      <div className="md:col-span-6 pr-4">
        ...
        <div className="text-xxl md:text-3xl font-light matrix-glow-text text-center">
                  <Typewriter
                    lines={[
                      "[1] Laught at their own jokes only?",
                      "[2] get friend-zoned forever?",
                      "[3] act busy but do nothing?",
                      "[4] disappear when bill arrives",
                      "[5] push bugs instead of features?",
                      "[6] Google “how to center a div” forever?",
                      "[7] use ChatGPT for everything? ",
                    ]}
                    showPrompt={false}
                    speed={32}
                    revealOnClick={true}
